// --- 1. STATE MANAGEMENT ---
// Kita simpan data todo dalam array
let todos = [];

// --- 2. FUNGSI NAVIGASI (Pindah Halaman) ---
...
// Render (Tampilkan) List
function renderTodos() {
    const listContainer = document.getElementById('todo-list');
    const emptyMsg = document.getElementById('empty-msg');
    
    listContainer.innerHTML = ''; // Bersihkan list sebelum render ulang
...
function saveTodo() {
    ...
    if (title === '') {
        // Tampilkan pesan error sederhana (visual)
...
// Helper untuk mencegah XSS (keamanan input)
